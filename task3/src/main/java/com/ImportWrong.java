...
public class ImportWrong {
    ...
    private static void loadUser(Connection con, Path file) throws IOException, SQLException {
        ...
        try (PreparedStatement psUser = con.prepareStatement(Usersql);
            PreparedStatement psFollow = con.prepareStatement(Followsql);
            ...
            psFollow.executeBatch();
            con.commit();
            System.out.println("User & follows 表导入完成");
        // } catch (IOException e) {
        //     e.printStackTrace();
        // }
    ...
    /* =================================================================
       recipes.csv -> table recipe, ingredient, recipe_ingredient, nutritional_information,
                       serving_information, keyword, recipe_keyword, favorite, time_information
       ================================================================= */
    private static void loadRecipe(Connection con, Path file) throws IOException, SQLException {
        ...
        try (
            ...
            psKey.executeBatch();
            con.commit();
            System.out.println("Recipe 及全部子表/关联表导入完成！总计 " + cnt + " 条食谱。");
        // }
        // catch (IOException e) {
        //     e.printStackTrace();
        // }
    ...
    /* =================================================================
       reviews.csv -> table review, Like
       ================================================================= */
    private static void loadReview(Connection con, Path file) throws SQLException {
        ...
        try (PreparedStatement psRev = con.prepareStatement(Revsql);
            ...
            psLike.executeBatch();
            con.commit();
            System.out.println("Review & Like 表导入完成");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    /* 数据日志 */
    private static void writeBadLine(Path file, String line, Exception e) {
        try (FileWriter w = new FileWriter("log/bad_" + file.getFileName(), true)) {
            w.write(line + " # " + e.getMessage() + "\n");
