...
public class MySQLImport {
    ...
    /* ===================== 连接常量 ===================== */
    private static final String URL   = "jdbc:mysql://localhost:3306/test_copy?useSSL=false&serverTimezone=UTC";
    private static final String USER  = "root"; // MySQL 用户名
    private static final String PWD   = "123456"; // MySQL 密码
    ...
    private static void loadUser(Connection con, Path file) throws IOException, SQLException {
        String Usersql =  "INSERT IGNORE INTO `User` (id,name,gender,age,followers_count,following_count) VALUES (?,?,?,?,?,?)";
    ...
    private static void loadFollows(Connection con, Path file) throws IOException, SQLException {
        String Followsql =  "INSERT IGNORE INTO `Follows` (follower_id,following_id) VALUES (?,?)";
    ...
    private static void loadRecipe(Connection con, Path file) throws IOException, SQLException {
        String recSql = "INSERT IGNORE INTO `Recipe` (id,name,author_id,date_published,description,category,aggregated_rating,review_count,instructions) VALUES (?,?,?,?,?,?,?,?,?)";
        try (
    ...
    private static void loadIngredient(Connection con, Path file) throws IOException, SQLException {
        String ingSql = "INSERT IGNORE INTO `Ingredient` (id,name) VALUES (?,?)";
        String recIngSql = "INSERT IGNORE INTO `Recipe_Ingredient` (recipe_id,ingredient_id) VALUES (?,?)";
    ...
    private static void loadNutritionalInformation(Connection con, Path file) throws IOException, SQLException {
        String nutSql =  "INSERT IGNORE INTO `Nutritional_Information` (recipe_id,calories,fat_content,saturated_fat,cholesterol,sodium,carbohydrate,fiber,sugar,protein) VALUES (?,?,?,?,?,?,?,?,?,?)";
        try (
    ...
    private static void loadServingInformation(Connection con, Path file) throws IOException, SQLException {
        String srvSql = "INSERT IGNORE INTO `Serving_Information` (recipe_id,servings,yield) VALUES (?,?,?)";
        try (
    ...
    private static void loadKeyword(Connection con, Path file) throws IOException, SQLException {
        String keySql = "INSERT IGNORE INTO `Keyword` (id,text) VALUES (?,?)";
        String recKeySql = "INSERT IGNORE INTO `Recipe_Keyword` (recipe_id,keyword_id) VALUES (?,?)";
        try (
    ...
    private static void loadFavorite(Connection con, Path file) throws IOException, SQLException {
        String favSql = "INSERT IGNORE INTO `Favorite` (author_id,recipe_id) VALUES (?,?)";
        try (
    ...
    private static void loadTimeInformation(Connection con, Path file) throws IOException, SQLException {
       String timeSql = "INSERT IGNORE INTO `Time_Information` (recipe_id,cook_time_minutes,prep_time_minutes,total_time_minutes) VALUES (?,?,?,?)";
       try (
    ...
    private static void loadReview(Connection con, Path file) throws SQLException, IOException {
         String Revsql = "INSERT IGNORE INTO `Review` (id,recipe_id,author_id,rating,content,date_submitted,date_modified) VALUES (?,?,?,?,?,?,?)";
        try (
    ...
    private static void loadLike(Connection con, Path file) throws SQLException, IOException {
       String likesql = "INSERT IGNORE INTO `Like` (author_id,review_id) VALUES (?,?)";
       try (
